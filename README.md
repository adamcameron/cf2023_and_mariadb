...
```
# start from your `cf2023_and_mariadb` directory.

$ pwd
/mnt/c/src/containers/cf2023_and_mariadb/
...
# ⠿ Network cf2023_and_mariadb_backend       Created          0.0s
# ⠿ Volume "cf2023_and_mariadb_mariaDbData"  Created          0.0s
# ⠿ Container cf2023_and_mariadb-cf2023-1     Started          2.0s
# ⠿ Container cf2023_and_mariadb-mariadb-1   Started          1.9s


$ docker exec --interactive --tty cf2023_and_mariadb-cf2023-1 /bin/bash
